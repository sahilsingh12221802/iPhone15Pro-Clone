...
const VideoCarousel = () => {
    ...
    const { isEnd, startPlay,
        videoId, isLastVideo, isPlaying } = video;
    ...
    return (
       ...
       mt-10">
        ...
        backdrop-blur rounded-full">
                    ...
                    rounded-full" ref={(el) => (videoSpanRef.current[i] =
                                    el)} />
                        </span>
                    ))}
                </div>
                <button className="control-btn">
                    <img
                        src={isLastVideo ? replayImg : !isPlaying
                            ? playImg : pauseImg}
                        alt={isLastVideo ? 'replay' : !isPlaying ?
                            'play' : 'pause'}
                        onClick={isLastVideo ? () =>
